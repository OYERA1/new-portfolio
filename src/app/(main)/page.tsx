...
export default function Home() {
	return <div className="contains flex-col gap-20 py-20">
		<div className=" flex flex-col gap-3 px-5 md:p-0">
			...
			<div className="mt-10 flex max-w-[400px] flex-col gap-20 px-5 md:flex-row md:px-0">
				<Link href={'https://cv.oyera.dev'} className="btn bg-neutral-800/90 font-semibold text-white/90 shadow-inner shadow-white/20 hover:bg-neutral-800 dark:bg-neutral-800/20 hover:dark:bg-neutral-800/75 ">
					Curriculo
				</Link>
		...
		<div className="contains flex-col gap-14 px-5 md:px-0" >
			...
			<div className="grid gap-7 md:grid-cols-2 ">
				...
				<Cards img={<Spotify className="text-[180px] md:text-[250px]" />} title="Playlist" link="/music" description="Quais músicas estou ouvindo no momento" />
			</div>
		</div>
	</div >
}
